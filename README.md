...
- **Challenge Overview:**  
  - Work with a string containing different types of parentheses.  
  - Understand how stack-based logic helps in validation problems.  
  - Use list operations to simulate stack behavior.  
  - Determine whether the given sequence of parentheses is valid.  

- **Topics Covered:**  
  - Stack data structure fundamentals  
  - Using lists as stacks in Python  
  - Push and pop operations  
  - Validation and parsing problems  
...
- **Reflection:**  
  This challenge introduced the practical use of stacks in solving parsing problems. By simulating stack behavior with Python lists, I learned how push and pop operations can validate sequences of parentheses. The exercise reinforced the importance of base logic in stack operations and showed how simple list manipulations can solve real-world problems like expression validation. It also highlighted how stacks naturally fit problems involving "last-in, first-out" order. Practicing this problem strengthened my confidence in applying data structures to problem-solving.

---

### Day-19: Min Stack (Software Engineering - Stack Design)

- **Problem Statement:**  
  Design a stack that supports the following operations efficiently:  
  - `push(x)`: Add element `x` onto the stack.  
  - `pop()`: Remove the element on top of the stack.  
  - `top()`: Retrieve the element on top of the stack.  
  - `getMin()`: Retrieve the minimum element in the stack.  

- **Challenge Overview:**  
  - Extend the basic stack data structure with additional functionality.  
  - Ensure that retrieving the minimum element is efficient.  
  - Optimize operations so they run in constant time.  
  - Explore how auxiliary data structures can be combined with stacks for real-world use cases.  
